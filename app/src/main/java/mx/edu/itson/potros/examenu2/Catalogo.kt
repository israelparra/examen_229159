...
class Catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = DetallesAdapter(producto,this)
    ...
    fun cargarProductos(){
        ...
        producto.add(Detalles(R.drawable.cumplebotanas"MINECRAFT","50"));
        ...
        peliculas.add(Pelicula("war",R.drawable.war,R.drawable.warheader,"British trenches somewhere in France. World war has been going on for the third year,\n" +
        ...
        peliculas.add(Pelicula("Suits",R.drawable.suits,R.drawable.suitsheader,"While running from a drug deal gone bad, brilliant young college dropout Mike Ross slips into a job\n" +
